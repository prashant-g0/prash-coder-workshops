          ...
          <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
            <div>
              ...
              <p className="mt-4 max-w-[600px] text-[16px] leading-7 text-[#565B60]">
                Notes from students after attending the workshop,
        ...
        <div className="mx-auto mt-12 max-w-7xl sm:mt-14">
          <div className="grid gap-5 sm:gap-6 lg:grid-cols-2">
            {testimonials.map((testimonial) => (
              ...
              >
                <div className="absolute -left-2 -top-2 z-10 flex h-8 w-8 items-center justify-center rounded-full border border-[#DEDFDA] bg-[#F6F6F3] text-[#1F6F5C] transition-transform duration-200 group-hover:-rotate-6"
                >
